...
import com.newland.tianyan.face.privateBean.BackendFacesetGetListRequest;
...
public class FacesetController {
    ...
    public NLBackend.BackendFacesetSendMessage getList(@RequestBody @Validated BackendFacesetGetListRequest receive) {
