 ...
 */
@Service
public class FastdfsImageStorageService {

    private String BASE64_PATTERN = "([A-Za-z0-9+/]{4})*([A-Za-z0-9+/]{3}=|[A-Za-z0-9+/]{2}==)?";
    private int MAX_IMAGE_SIZE = 1024 * 1024 * 2;
    private static String IMAGE_BASE64_PREFIX = "/9j/";
